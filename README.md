...
```sql
CREATE TABLE loginRecord (time int(10) PRIMARY KEY AUTO_INCREMENT, studentId char(7) NOT NULL, ip char(45) NOT NULL, browser varchar(30) NOT NULL, country varchar(30) NOT NULL, FOREIGN KEY (studentId) REFERENCES users(studentId));
```
